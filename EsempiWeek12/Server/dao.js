...
// open the database
const db = new sqlite.Database('exams2.sqlite', (err) => {
  if(err) throw err;
});
//si tratta di una serie di funzioni che vengono esportate una per una, sono funzioni che hai guià imparato a scrivere, si tratta delle query in SQl.
// get all courses
exports.listCourses = () => {
